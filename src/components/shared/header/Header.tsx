...
export default function Header() {
   return (
      <header className="z-(--header-index) px-4 max-sm:px-1.5 py-2 pt-4 h-(--header-height) bg-theme flex justify-between items-center gap-3 max-sm:gap-1 overflow-hidden fixed top-0 left-0 w-full">
